            ...
            <div class="card-body">
                <form class="row g-3 mt-3" action="../routers/r_foto.php?aksi=update" method="post" enctype="multipart/form-data">
                    <?php foreach($tampil->edit($_GET['fotoid']) as $edit) : ?>
                        ...
                        <div class="col-md-12">
                            <input type="text" name="JudulFoto" class="form-control" placeholder="Tittle photo" maxlength="15" value="<?= $edit->JudulFoto ?>" required>
                        </div>
                        <div class="col-md-12">
                            <input type="text" name="DeskripsiFoto" class="form-control" placeholder="Description | Optional" value="<?= $edit->DeskripsiFoto ?>">
                        </div>
