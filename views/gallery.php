        ...
        <div class="card">
            <div class="container">
                <div class="user-block">
                    <a class="nav-link nav-profile d-flex align-items-center pe-0" data-bs-toggle="dropdown">
                        <img src="../assets/img/<?= $img ?>" width="45" height="45" alt="Profile" class="rounded-circle">
                        <div class="row">
                            <span class="username"><?= $tampil->Username ?></span>
                            <span class="p">Publish - <?= $tampil->TanggalUnggah ?></span>
                        </div>
                    </a>
                </div>
            </div>
            <div class="card-body">
                ...
                <?php if ($tampilike->user($tampil->FotoID, $id) == 0) { ?>
                    <a href="../routers/r_like.php?FotoID=<?= $tampil->FotoID ?>&UserID=<?= $id ?>&aksi=like"><i class="text-secondary bx bx-like"></i></a>
                <?php } else { ?>
                    <a href="../routers/r_like.php?UserID=<?= $id ?>&aksi=delete"><i class="text-secondary bx bxs-like"></i></a>
                <?php }
                    ...
                    <?php foreach ($komentar->read_komentar($tampil->FotoID) as $komen) : ?>
                        <div class="alert alert-dark alert-dismissible fade show" col-lg-12 role="alert">
                            <a class="nav-link nav-profile d-flex align-items-center pe-0" data-bs-toggle="dropdown">
                                ...
                                <div class="row">
                                    <span class="username"><?= $komen->Username ?></span>
                                    <span class="p"><?= $komen->IsiKomentar ?></span>
                                </div>
