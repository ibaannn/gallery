                        ...
                        <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
                            ...
                            <div class="card mb-3">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="pt-4 pb-2">
                                        <h5 class="card-title text-dark text-center pb-0 fs-4">Login to Your Account</h5>
                                    </div>

                                    <form class="row g-3 needs-validation" novalidate action="routers/r_login.php?aksi=login" method="post">

                                        <div class="col-12">
                                            <label for="yourUsername" class="form-label">Username or Email</label>
                                            <div class="input-group has-validation">
                                                <input type="text" name="usermail" class="form-control" id="yourUsername" required placeholder="Username | Email">
