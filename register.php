                        ...
                        <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
                            ...
                            <div class="card mb-3">
                                ...
                                <div class="card-body">
                                    ...
                                    <form class="row g-3 needs-validation" action="password.php" method="post" novalidate>
                                        ...
                                        <div class="col-12">
                                            ...
                                            <div class="input-group has-validation">
                                                <input type="text" name="fullname" class="form-control" id="namalengkap" required placeholder="Full Name">
                                        ...
                                        <div class="col-12">
                                            ...
                                            <div class="input-group has-validation">
                                                <input type="address" name="address" class="form-control" id="alamat" required placeholder="Address">
                                        ...
                                        <div class="col-12">
                                            <button class="btn btn-primary w-100" type="submit" name="register">Next</button>
                                        </div>
                                        <div class="col-12">
                                            <p class="small mb-0">Aleardy have an account? <a href="index.php">Log in an account</a></p>
                                        </div>
                                    </form>
